...
void Cubemap::DrawCubemap(Shader& skyboxShader)
{
    // draw skybox as last
...
void Cubemap::InitializeVertices()
{
    float temp[] = {
        // positions          
        -1.0f,  1.0f, -1.0f,
    ...
    std::copy(std::begin(temp), std::end(temp), std::begin(skyboxVertices));
}
